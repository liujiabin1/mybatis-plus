...
public class TestAutoGenerate {
    ...
    public void autoGenerate() {
        ...
        // 填写代码生成的目录(需要修改)
        String projectPath = "/Users/zrb/IdeaProjects/test/mybatis-plus";
        // 拼接出代码最终输出的目录
        gc.setOutputDir(projectPath + "/src/main/java");
        // 配置开发者信息（可选）（需要修改）
        gc.setAuthor("liuailan");
...
//        pc.setModuleName("mybatis-plus");
        ...
        strategy.setInclude("user","ability_type","ability_aims");
        // 配置数据表与实体类名之间映射的策略
